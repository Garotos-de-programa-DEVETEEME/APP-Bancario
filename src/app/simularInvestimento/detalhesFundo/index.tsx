...
export default function DetalhesInvestimento() {
  ...
  const isButtonEnabled = fund
    ? valorAplicarEmCentavos >= fund.valorAplicacaoInicial * 100 &&
      valorSalvoDropdown !== ''
    : false;
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.container}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.value}>
                  {new Intl.NumberFormat('pt-BR', {
                    style: 'currency',
                    currency: 'BRL',
                  }).format(fund.valorAplicacaoInicial)}
                </Text>
              </View>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.value}>
                  R${' '}
                  {fund.valorMinimoAplicacaoInternet /
                    fund.valorMinimoResgateInternet}
                </Text>
              </View>
              ...
              <View style={styles.resultsContainer}>
                <View style={styles.valueDisplay}>
                  <Text style={styles.mainValues}>Aplicação inicial</Text>
                ...
                <View style={styles.valueDisplay}>
                  <Text style={styles.mainValues}>Resgate</Text>
                  {/* //TODO Adicionar calculo do resultado */}
                  {/* RESULTADO PLACEHOLDER NÃO É VERDADE ESSE ! ! ! */}
                  <Text style={styles.mainValues}>
                    {formatCurrency(
                      valorAplicarEmCentavos + valorAplicarEmCentavos * 0.1,
                    )}
                  </Text>
                </View>
              </View>
