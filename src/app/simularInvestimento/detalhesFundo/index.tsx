...
export default function DetalhesInvestimento() {
    ...
    if (!fundData || typeof fundData !== 'string') {
        return (
    ...
    const fund: fundsType = JSON.parse(fundData);
        ...
        <ScrollView style={styles.scrollView}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.detailRow}>
                    ...
                    <Text style={styles.value}>R$ {fund.valorAplicacaoInicial.toFixed(2)}</Text>
                </View>
                ...
                <View style={styles.detailRow}>
                    ...
                    <Text style={styles.value}>D+{fund.prazoConversaoResgate} (Dias Úteis)</Text>
                </View>
            </View>
        </ScrollView>
    );
