...
export const fundosDestaque: FundoInvestimento[] = [
  {
    ...
    codigo: 28,
    nome: 'Banestes Invest Fácil FI RF Simples',
    siglaFundo: 'FBS',
    nomeReduzido: 'Invest Fácil Simples',
  ...
  // ... cole todos os outros objetos de fundos aqui
  {
    ...
    identificadorResgatavelInternet: 'S',
    codigo: 35,
    nome: 'Banestes Reserva Climática FIF RF DI',
    siglaFundo: 'BRC',
    nomeReduzido: 'Banestes R Climática',
    identificadorRestricaoFundos: 1,
    fundoPrazoCreditoConta: 0,
    prazoConversaoResgate: 0,
